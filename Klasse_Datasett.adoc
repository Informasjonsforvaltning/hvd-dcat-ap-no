...
| Multiplisitet / _Multiplicity_ | 0..n #(@@@@@@ NB! Inkonsistens i EUs DCAT-AP HVD, der multiplisiteten oppgis som 1..n, mens egenskapen er i Annex A kategorisert som Recommended)#
