...
* Bruke de kontrollerte vokabularene som er beskrevet i Merknad til den enkelte egenskapen i <<Spesifikasjon_per_klasse, denne standarden>> og i https://informasjonsforvaltning.github.io/dcat-ap-no/#Spesifikasjon-per-klasse[DCAT-AP-NO &#x29C9;, window="_blank", role="ext-link"]. 
