...
** En bulknedlasting kan gjøres tilgjengelig via API, ved å bruke egenskapen https://informasjonsforvaltning.github.io/dcat-ap-no/#Distribusjon-tilgangstjeneste[Distribusjon – tilgangstjeneste (dcat:accessService) &#x29C9;, window="_blank", role="ext-link"] fra distribusjonsbeskrivelsen. 
