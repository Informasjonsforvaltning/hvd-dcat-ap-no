...
__Article 3.3 in HVD IR specifies that the terms of use should be provided. According to the guidelines under <<Spesielt_om_juridisk_info>> (in Norwegian only) this is fulfilled by referring to a licence. As alternative the property <<Datatjeneste-rettigheter>> can be used.__
|===
