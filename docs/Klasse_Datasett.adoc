...
<<diagram-Klassen-Datasett>> viser klassen Datasett og dens egenskaper, samt klassene den refererer til. I figuren er differansen mellom kravene i HVD-DCAT-AP-NO og DCAT-AP-NO markert gult. Kun differansen er videre spesifisert i dette kapitelet. Kravene ellers til https://informasjonsforvaltning.github.io/dcat-ap-no/#Datasett[klassen Datasett (dcat:Dataset) i DCAT-AP-NO &#x29C9;, window="_blank", role="ext-link"] gjelder også for denne klassen her.
...
_This property is used to refer to ..._
| Multiplisitet / _Multiplicity_ | 1..n
| Kravnivå / _Requirement level_ | Obligatorisk / _Mandatory_
...
__The provided information should enable to the verification whether the detailed information requirements by the HVD is satisfied.__ 
|===
