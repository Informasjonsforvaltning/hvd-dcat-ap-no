...
** Et datasett kan inngå i en **datasettserie**. Se også https://informasjonsforvaltning.github.io/dcat-ap-no/#Om-Datasettserie[Om bruk av datasettserie i DCAT-AP-NO &#x29C9;, window="_blank", role="ext-link"].
